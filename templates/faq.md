...
## Contents
- [How does the analysis work?](#how-analysis)
- [Is this tool active or passive?](#active-passive)
- [What are the limitations?](#limitations)
- [Which TLDs support RDAP?](#rdap-tlds)
- [How can I interpret the results?](#interpret-results)
- [How can I save my results?](#save-results)
- [Why don't I see any data for the Last-Modified headers?](#no-modified-headers)
- [Can I get Last-Modified header information for a site that requires authentication?](#auth-headers)
- [Is Last-Modified header information the same as file metadata/EXIF?](#metadata)
- [I don't get any results from the domain registration query](#no-rdap)
- [Why not use WHOIS?](#why-not-whois)
- [Why use SSL certificates?](#why-ssl)
- [Why does it sometimes take so long to get data?](#slow-data)
- [Why not use article publication timestamps?](#publication-timestamps)
- [Why do the Last Modified results show a 403 or 404 error?](#errors)
- [Why do my results show that the first SSL certificate was obtained before the domain registration?](#cert-before-domain)
- [Can I host this myself?](#self-host)
- [What if there is a bug?](#bugs)
- [What other useful things can I use SSL certificates for?](#other-ssl-uses)
- [What information do you collect about my queries?](#privacy)

### <a id="how-analysis"></a>How does the analysis work?
...
### <a id="active-passive"></a>Is this tool active or passive?
...
### <a id="limitations"></a>What are the limitations?
...
### <a id="rdap-tlds"></a>Which TLDs support RDAP?
...
### <a id="interpret-results"></a>How can I interpret the results?
...
### <a id="save-results"></a>How can I save my results?
All results from your queries can be exported as CSV files. You can also export the webpage as a PNG or PDF.

### <a id="no-modified-headers"></a>Why don't I see any data for the Last-Modified headers from the URL that I queried?
Not all websites use Last-Modified headers, so this technique will not work for them.

### <a id="auth-headers"></a>Can I get Last-Modified header information for a site that requires authentication?
Probably not. The tool cannot bypass authentication requirements or log in to sites on your behalf.

### <a id="metadata"></a>Is Last-Modified header information the same as file metadata/EXIF?
...
### <a id="no-rdap"></a>I don't get any results from the domain registration query.
...
### <a id="why-not-whois"></a>Why not use WHOIS?
...
### <a id="why-ssl"></a>Why use SSL certificates?
...
### <a id="slow-data"></a>Why does it take so long to get data?
...
### <a id="publication-timestamps"></a>Why not use article publication timestamps?
...
### <a id="errors"></a>Why do the Last Modified results show a 403 or 404 error when I can access the site in my browser?
...
### <a id="cert-before-domain"></a>The results show that the first SSL certificate was obtained before the domain was even registered - how is this even possible?
...
### <a id="self-host"></a>Can I host this myself?
...
### <a id="bugs"></a>What if there is a bug?
...
### <a id="other-ssl-uses"></a>What other useful things can I use SSL certificates for?
...
### <a id="privacy"></a>What information do you collect about my queries?
